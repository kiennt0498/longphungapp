export const giaCongDoan = (list, chieuDai, chieuRong) => {
  ...
  list.forEach((cd) => {
    ...
    total += tongChiPhi;
    console.log("cong doan", total);
  });

  console.log("total cong doan", total);
...
export const giaNguyenLieu = (list, chieuDai, chieuRong) => {
  ...
  console.log("total nguyen lieu", total);
  return total;
};

export const tinhGiaBan = (product, chieuDai, chieuRong) => {
  
  const gia =  giaCongDoan(product.quyTrinh?.congDoans || [], chieuDai, chieuRong) +
